...
/*   Updated: 2015/04/01 17:30:47 by cfriot           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

//>& fichier pour voir le putchar_fd
...
static void				check_ft_putchar_fd(void)
{
	ft_putchar_fd('s', 2);
	ft_putchar_fd('o', 2);
	ft_putchar_fd('r', 2);
...
static void				check_ft_putstr_fd(void)
{
	ft_puts_fd("ecriture sur le fd 0", 0);
	ft_puts_fd("ecriture sur le fd 2", 2);
	ft_puts_fd("------puts_fd OK------", 1);
}
...
static void check_ft_puts()
{
	ft_puts(NULL);
	ft_puts("");
	ft_puts("une chaine normale");
	ft_puts("deuxieme test");
	ft_puts("------puts OK------");
}
...
static int				check_ft_strcat(void)
{
	...
	b = strcat(dest2, "");
	a = strcat(dest, "hello");
	b = strcat(dest2, "hello");
	a = strcat(dest, " bien le bonjour");
	b = strcat(dest2, " bien le bonjour");
	if (strcmp(a, b) == 0)
		ft_puts("------strcat OK------");
	return (1);
}
